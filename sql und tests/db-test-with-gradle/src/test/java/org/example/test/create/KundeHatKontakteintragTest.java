...
public class KundeHatKontakteintragTest {
    ...
    public void insert_correct_success() throws Exception {
        String insertSql = "INSERT INTO KundeHatKontakteintrag VALUES (1, 1);";
    ...
    public void insert_kontaktEintragAlreadyUsed_failed() throws Exception {
        String insertSql = "INSERT INTO KundeHatKontakteintrag VALUES (2, 1);";
    ...
    private void createRelatedTables() throws Exception {
        ...
        String createTableSql9 =
                "CREATE TABLE PersonHatKontakteintrag (" +
                        ...
                        ");";
        String insertSql10 = "INSERT INTO PersonHatKontakteintrag VALUES (2, 1);";
